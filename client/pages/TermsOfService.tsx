        ...
        >
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Welcome to PalmPay Secure. These terms govern your use of our
              biometric payment platform and services.
            </p>
          ...
          >
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  By accessing or using PalmPay Secure ("the Service"), you
                ...
                <p>
                  ...
                  You must be at least 18 years old to use PalmPay Secure. By
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  PalmPay Secure provides contactless payment services using
                  palm print, facial recognition, and voice authentication
                  technologies.
                </p>
                <p>
                  <strong className="text-foreground">
                  ...
                  We facilitate secure transactions between users and merchants
                  through our biometric authentication platform.
                </p>
                <p>
                  <strong className="text-foreground">Digital Wallet:</strong>{" "}
                  The Service includes secure storage and management of digital
                ...
                <p>
                  ...
                  Our platform includes SOS functionality for user safety in
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  You must provide and maintain accurate, current information in
                  your account and for all transactions.
                </p>
                <p>
                ...
                <p>
                  <strong className="text-foreground">Device Security:</strong>{" "}
                  You are responsible for maintaining the security of devices
                  used to access the Service.
                </p>
                <p>
                  <strong className="text-foreground">Biometric Data:</strong>{" "}
                  You consent to the collection and use of your biometric data
                ...
                <div className="bg-orange-500/10 border border-orange-400/30 rounded-2xl p-6">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm">
                        Never share your account credentials or attempt to
                        bypass biometric authentication measures. Report any
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  By completing a biometric authentication, you authorize the
                  requested payment transaction.
                </p>
                <p>
                  <strong className="text-foreground">Fees:</strong> PalmPay
                  Secure may charge fees for certain services. All applicable
                  fees will be clearly disclosed before transaction completion.
                </p>
                <p>
                  <strong className="text-foreground">Disputes:</strong> For
                  transaction disputes, contact us within 60 days of the
                  transaction. We will investigate and resolve disputes
                  according to applicable payment network rules.
                </p>
                <p>
                  <strong className="text-foreground">Refunds:</strong> Refunds
                  are processed according to merchant policies and payment
                  network rules. We do not guarantee refunds for completed
                  transactions.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  ...
                  We employ federated learning and end-to-end encryption to
                ...
                <p>
                  ...
                  We may integrate with trusted third-party services for payment
                  processing and security enhancement.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  ...
                  While our biometric systems are highly accurate, we cannot
                  guarantee 100% accuracy in all conditions.
                </p>
                <p>
                  <strong className="text-foreground">
                ...
                <p>
                  <strong className="text-foreground">Force Majeure:</strong> We
                  are not responsible for delays or failures due to
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  ...
                  or for business reasons with appropriate notice.
                </p>
                <p>
                  <strong className="text-foreground">Data Deletion:</strong>{" "}
                  Upon termination, your account data will be deleted according
                  to our data retention policies and legal requirements.
                </p>
                <p>
                  <strong className="text-foreground">Survival:</strong> Certain
                  provisions of these Terms will survive termination, including
                  privacy obligations and limitation of liability.
                </p>
              </div>
            </section>
                ...
                <div className="bg-card/30 rounded-2xl p-6 border border-border/40">
                  <div className="space-y-2">
                    <p>
                      ...
                      legal@palmpaysecure.com
                    </p>
                    <p>
                      <strong className="text-foreground">Support:</strong>{" "}
                      support@palmpaysecure.com
                    </p>
                    <p>
                      <strong className="text-foreground">Address:</strong>{" "}
                      PalmPay Secure, Inc.
                      <br />
                      123 Biometric Avenue
                      <br />
          ...
          >
            <div className="flex justify-center space-x-8 text-sm text-muted-foreground">
              ...
              <Link to="/" className="hover:text-cyber-cyan transition-colors">
                Home
              </Link>
            </div>

            <p className="text-xs text-muted-foreground">
              © 2024 PalmPay Secure. All rights reserved. Your security is our
              commitment.
            </p>
          </motion.div>
        </motion.div>
