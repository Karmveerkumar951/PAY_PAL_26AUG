        ...
        >
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              ...
              protect your biometric data and personal information.
            </p>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  We collect palm print patterns, facial recognition data, and
                  voice prints solely for authentication purposes. This data is
                  encrypted and stored locally on your device using federated
                  learning technology.
                </p>
                <p>
                  ...
                  Name, email address, phone number, and payment preferences to
                  facilitate secure transactions and account management.
                </p>
                <p>
                  <strong className="text-foreground">Transaction Data:</strong>{" "}
                  Payment history, merchant information, and transaction amounts
                ...
                <p>
                  ...
                  Device identifiers, operating system, and security features to
                  ensure compatibility and enhance security.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  Biometric data is used exclusively for user authentication and
                  access control to your account and payment services.
                </p>
                <p>
                  <strong className="text-foreground">
                    Transaction Processing:
                  </strong>{" "}
                  Personal and transaction data facilitates secure payment
                  processing and merchant communications.
                </p>
                <p>
                  <strong className="text-foreground">
                    Security & Fraud Prevention:
                  </strong>{" "}
                  We analyze patterns to detect and prevent unauthorized access
                ...
                <p>
                  ...
                  Aggregated, anonymized data helps us enhance our services and
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  Your biometric templates never leave your device. Only
                  encrypted model updates are shared for system improvements.
                </p>
                <p>
                  <strong className="text-foreground">
                    End-to-End Encryption:
                  </strong>{" "}
                  All data transmissions use bank-grade AES-256 encryption with
                ...
                <p>
                  ...
                  We cannot access your raw biometric data, even with
                  administrative privileges.
                </p>
                <p>
                  <strong className="text-foreground">Secure Storage:</strong>{" "}
                  Personal data is encrypted at rest using industry-standard
                  security protocols and stored in certified secure facilities.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  Your personal information and biometric data are never sold,
                ...
                <p>
                  ...
                  Minimal transaction data is shared with payment processors and
                  banks as required for transaction completion.
                </p>
                <p>
                  <strong className="text-foreground">Legal Compliance:</strong>{" "}
                  We may disclose information when required by law, court order,
                  or to protect our users' safety and security.
                </p>
                <p>
                  <strong className="text-foreground">
                    Emergency Situations:
                  </strong>{" "}
                  In case of SOS activation, location and emergency contact
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  Request copies of your personal data in a machine-readable
                  format.
                </p>
                <p>
                  <strong className="text-foreground">
                ...
                <p>
                  ...
                  deletion of your account and associated data. Biometric
                  templates are automatically deleted from your device.
                </p>
                <p>
                  <strong className="text-foreground">
                    Consent Withdrawal:
                  </strong>{" "}
                  Withdraw consent for data processing at any time, though this
          ...
          >
            ...
            <p className="text-xs text-muted-foreground">
              © 2024 PalmPay Secure. All rights reserved. Built with privacy by
              design.
            </p>
          </motion.div>
        </motion.div>
